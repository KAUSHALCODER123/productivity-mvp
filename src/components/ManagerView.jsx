...
const ManagerView = ({ teamMetrics, developers }) => {
  return (
    <motion.div 
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
    ...
    >
      ...
      <div className="metric-grid">
        <MetricCard label="Avg Lead Time" value={teamMetrics.avgLeadTime} unit="hrs" trend={-5} badge="cyan" />
        <MetricCard label="Avg Cycle Time" value={teamMetrics.avgCycleTime} unit="hrs" trend={8} badge="magenta" />
        <MetricCard label="Team Throughput" value={teamMetrics.totalThroughput} unit="PRs" trend={12} />
        <MetricCard label="System Bug Rate" value={teamMetrics.avgBugRate} unit="%" trend={-2} />
      </div>
